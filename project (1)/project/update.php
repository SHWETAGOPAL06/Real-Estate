...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="tel" name="name" maxlength="50" placeholder="name" class="box">
      <input type="email" name="email" maxlength="50" placeholder="email" class="box">
      <input type="number" name="number" min="0" max="9999999999" maxlength="10" placeholder="number" class="box">
