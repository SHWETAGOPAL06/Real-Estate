...
<section class="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>buy house</h3>
         <p>With property selling roles bein so varied, good service look different for everyone.</p>
      </div>

      <div class="box">
         <img src="https://tse3.mm.bing.net/th?id=OIP.4gS0k6N2BXmCub2GmN82nQHaH0&pid=Api&P=0&h=220" alt="">
         <h3>Sell Plot</h3>
         <p>With property selling roles bein so varied, good service look different for everyone.</p>
      </div>
  ...
  <!-- <section class="listings">
   ...
   <div class="box-container">  -->
      ...
      <?php
         ...
         echo '<p class="empty">no properties added yet! <a href="post_property.php" style=" margin-top: 1.5rem;
         border-radius: 18px;
         background: blueviolet;" class="btn">add new</a></p>';
      }
      ?>
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="listings.php" class="inline-btn" style="border-radius: 15px;
    margin-bottom: 5px;">view all</a>
   </div>
