...
<section class="faq" id="faq">
   ...
   <div class="box-container">
      ...
      <div class="box active">
         ...
         <p>As long as the agreement is not registered, the seller cannot any money from the advance amount.</p>
      </div>

      <div class="box active">
         <h3><span>when will I get the possession?</span><i class="fas fa-angle-down"></i></h3>
         <p>Once the builder-buyer agreement is registered, the buyer may have to forfeit a part of the booking amount upon cancellation.</p>
      </div>

      <div class="box">
         <h3><span>where can I pay the rent?</span><i class="fas fa-angle-down"></i></h3>
         <p>A buyer can approach the Real Estate Regulatory Authority in their state, for grievances arising from the cancellation of a flat booking.</p>
      </div>

      <div class="box">
         <h3><span>how to contact with the buyers?</span><i class="fas fa-angle-down"></i></h3>
         <p>If you bought a resale home through an individual seller, you will have to approach the consumer court, toget your grievance addressed.</p>
      </div>
